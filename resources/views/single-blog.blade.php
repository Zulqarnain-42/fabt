                                ...
                                <div class="col-lg-6">
                                    <div class="cont">
                                        <small class="date small mb-20">
                                            <span class="text-uppercase border-end brd-gray pe-3 me-3"> News </span>
                                        ...
                                        <p class="fs-12px mt-10 text-light text-info">
                                            If there’s one way that wireless
                                            technology has changed the way we work, it’s that will everyone is now connected
                                            [...]
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="blog-content-info">
                            <h4 class="fw-bold color-000 lh-4 mb-30">
                                ...
                                <a href="#" class="color-blue5">Moussa</a> and German studio Schultzschultz
                                have created The Lodge Wooden at Berlin City
                            </h4>
                            <div class="text mb-10 color-666">
                                ...
                                no attention to their mental health, no vacations, not even the occasional long weekend. All
                            ...
                            <div class="text color-666 mb-20">
                                ...
                                tourist. <br> Located in the heart of Warwickshire.
                            </div>
                            <div class="info-imgs">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="img text-center mt-30">
                                            ...
                                            <span class="color-999 fs-12px mt-20">Images by
                                                <a href="#" class="color-000">@sample</a>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div class="text mt-50 color-666">
                                The short answer is yes. According to Kross, when you think of yourself as another person,
                                it allows you lorem ispum lorem suo give yourself more. Notre dame at sume lorem objective,
                                helpful feedback.
                            </div>
                            <div class="twitter-info mt-60">
                                <div class="twitter-card">
                                    ...
                                    <div class="twitter-info mt-40">
                                        <h5>
                                            “The team at <a href="#" class="color-blue5">@iteckagency</a> is
                                            incredibly dedicated, knowledgeable, and helpful. The finished product was
                                            beautiful, and worth every penny. I would absolutely recommend Iteck WP Theme.”
                                        </h5>
                                    </div>
                                </div>
                                <h4>Defaulting to Mindfulness</h4>
                                <div class="text color-666 mt-30">
                                    Cray post-ironic plaid, Helvetica keffiyeh tousled Carles banjo before they sold out
                                    blog photo booth Marfa semio tics Truffaut. Mustache Schlitz next level blog
                                    Williamsburg, deep v typewriter tote bag
                                </div>
                                <ul class="ps-1 ps-lg-5 my-4 color-666 fs-14px lh-7">
                                    ...
                                    <li class="d-flex">
                                        <i class="bi bi-dot me-2 fs-3 lh-2 pt-1"></i>
                                        In their classic book, Creativity in Business, based on a popular course they
                                        co-taught
                                    </li>
                                    <li class="d-flex">
                                        <i class="bi bi-dot me-2 fs-3 lh-2 pt-1"></i>
                                ...
                                <div class="text color-666 mt-30">
                                    ...
                                    <a href="#" class="text-decoration-underline color-blue5">my fondest</a>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="inf">
                                            ...
                                            <div class="text color-000 fs-12px mt-10">
                                                ...
                                                deserunt mollit anim id est laborum sed ut perspiciatis unde. Lorem ispum
                                                dolor sit amet
                                            </div>
                                        ...
                                        <div class="d-flex comment-cont">
                                            ...
                                            <div class="inf">
                                                ...
                                                <div class="text color-000 fs-12px mt-10">
                                                    ...
                                                    tempor incididunt ut labore et dolore magna aliqua. Atume nusaate staman
                                                    utra phone limo sumeria
                                                </div>
                                                <a href="#"
