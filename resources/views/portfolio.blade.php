        ...
        <section class="portfolio-projects section-padding pt-50 style-1">
            <div class="container">
                ...
                <div class="controls">
                    ...
                    <button type="button" class="control" data-filter=".broadcast">Broadcast Facility</button>
                    <button type="button" class="control" data-filter=".display">Immersive Display</button>
                    <button type="button" class="control" data-filter=".rftransmission">RF Transmission</button>
                    <button type="button" class="control" data-filter=".obvan">OB VAN</button>
                    <button type="button" class="control" data-filter=".integration">System Integration</button>
                    <button type="button" class="control" data-filter=".projection">Projection & Holograms</button>
                    <button type="button" class="control" data-filter=".exhibitions">Exhibitions & Museums</button>
                    <button type="button" class="control" data-filter=".eventsprojects">Events & Projects</button>
                </div>
                        ...
                        <div class="row mix-container">
                            <div class="col-lg-4 mix security consultation">
                                <div class="portfolio-card mb-50">
                                    ...
                                    <div class="info">
                                        <h5>
                                            <a href=""> Infrastructure Upgrade </a>
                                        </h5>
                            ...
                            <div class="col-lg-4 mix design security">
                                <div class="portfolio-card mb-50">
                                    ...
                                    <div class="info">
                                        <h5>
                                            <a href="#"> Criftocy Landing Page </a>
                                        </h5>
                            ...
                            <div class="col-lg-4 mix development consultation">
                                <div class="portfolio-card">
                                    ...
                                    <div class="info">
                                        <h5>
                                            <a href="#"> Robotchat AI Development </a>
                                        </h5>
...
@section('scripts')
    <script src="{{ URL::asset('assets/js/lib/mixitup.min.js') }}"></script>
    <script>
